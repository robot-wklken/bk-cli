...
// Package aidev implements the AIDev system command and its YAML-defined actions.
package aidev
...
// NewSystemSpec returns the top-level aidev system spec used during command registration.
